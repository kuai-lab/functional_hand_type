...
class TemporalNet(torch.nn.Module):
    def __init__(self,  is_single_hand,
        ...
        # Hyperparameters
        self.lambda_hand_z=10 # 100
        self.lambda_hand_2d=0.1 # 1    
        self.lambda_action_loss=0.1 # 1
        ...
        self.concat_to_action_input=torch.nn.Linear(transformer_d_model*4,transformer_d_model)
    ...
    def forward(self, batch_flatten, train=True, verbose=False):
        ...
        flatten_ain_feature=torch.cat((flatten_pout_feature,flatten_ain_feature_hpose,flatten_ain_feature_olabel,flatten_ain_feature_hlabel_txt),dim=1)
    ...
    def recover_hand(self, flatten_sample, flatten_hpose_25d_3d, weights, total_loss,verbose=False):
        ...
        hpose_loss+=hand_losses["recov_joints2d"]*self.lambda_hand_2d + hand_losses["recov_joints_absz"]*self.lambda_hand_z + hand_losses["recov_joint_angle"]*self.lambda_hand_z/100+hand_losses["recov_joint_NCJ"]*self.lambda_hand_z/10
